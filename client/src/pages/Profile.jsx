    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <input onChange={(e)=>setFile(e.target.files[0])} type="file" ref={fileRef} hidden accept='image/*'/>
        ...
        <p className='text-sm self-center' >               {fileUploadError ? 
                            ...
                            filePerc>0 && filePerc<100 ?  (<span className='text-slate-700'>{`uploading ${filePerc}%`}</span>) : filePerc === 100 ? (<span className='text-green-700'>Image Succesfully Uploaded!</span>):""
                            }</p>
        ...
        <button disabled={loading}className='bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-95 disable:opacity-80'>{loading ? 'loading....' : 'Update'}</button>
      ...
      <h1 className='text-centre mt-7 text-2xl font-semibold'> Your Listings</h1>
        {

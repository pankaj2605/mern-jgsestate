            ...
            <form className='flex flex-col gap-8' onSubmit={handleSubmit}>
                ...
                <div className='flex gap-2 flex-wrap items-center'>
                    ...
                    <div className='flex gap-2'>
                        <input type="checkbox" id="all" className='w-4' checked={sidebardata.type === 'all'} onChange={handleChange}/>
                        <span>Rent & Sale </span>
                    </div>
                    <div className='flex gap-2'>
                    ...
                    <div className='flex gap-2'>
                        <input type="checkbox" id="offer" className='w-4' checked={sidebardata.offer} onChange={handleChange}/>
                        <span>Offer</span>
                    </div>
                </div>
                <div className='flex gap-2 flex-wrap items-center'>
                    ...
                    <div className='flex gap-2'>
                        <input type="checkbox" id="parking" className='w-4' checked={sidebardata.parking} onChange={handleChange}/>
                        <span>Parking </span>
                    </div>
                    <div className='flex gap-2'>
                        <input type="checkbox" id="furnished" className='w-4'checked={sidebardata.furnished} onChange={handleChange}/>
                        <span>Furnished </span>
                    </div>
                </div>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <select defaultValue={'created_at_desc'} onChange={handleChange}id="sort_order" className='border rounded-lg p-3 h-12 w-60'>
